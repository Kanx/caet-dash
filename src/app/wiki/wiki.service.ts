...
export class WikiService {
  ...
  getArticles() {
    return this.sp.getListItems(this.listName, 'Title,TopicID,ID,Content', 'Author/Name').map(data => data.d.results);
  }

  getArticle(id) {
    return this.sp.getListItem(this.listName, id, '', 'Author/Name').map(data => data.d);
  }
